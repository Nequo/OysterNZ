...
public class JourneyPriceCalculatorTest
{
    ...
    {
        assertThat(JourneyPriceCalculator.TotalPriceFor(fakeJourneyCreator.getFakeJourneys(1, false, fakeJourneyCreator.longJourneys)),
    ...
    {
        assertThat(JourneyPriceCalculator.TotalPriceFor(
                fakeJourneyCreator.getFakeJourneys(1, true, fakeJourneyCreator.longJourneys)),
    ...
    {
        assertThat(JourneyPriceCalculator.TotalPriceFor(
                fakeJourneyCreator.getFakeJourneys(1, false, fakeJourneyCreator.shortJourneys)),
    ...
    {
        assertThat(JourneyPriceCalculator.TotalPriceFor(fakeJourneyCreator.getFakeJourneys(1, true, fakeJourneyCreator.shortJourneys)),
    ...
    {
        assertThat(JourneyPriceCalculator.TotalPriceFor(fakeJourneyCreator.getFakeJourneys(5, false, fakeJourneyCreator.shortJourneys)),
    ...
    {
        assertThat(JourneyPriceCalculator.TotalPriceFor(
                fakeJourneyCreator.getFakeJourneys(5, true, fakeJourneyCreator.shortJourneys)),
