...
public class TravelTrackerTest
{
    ...
    Database customers = context.mock(Database.class);
    ...
    public void theDatabaseReturnsTheCorrectDataSet(){
        ...
        context.checking(new Expectations(){{
            oneOf(customers).getCustomers();will(returnValue(customers1));
        }});
    ...
    @Test
    public void theDatabaseIsFetchedWhenYouChargeTheAccounts(){

        context.checking(new Expectations(){{
            exactly(1).of(customers).getCustomers();
        }});
